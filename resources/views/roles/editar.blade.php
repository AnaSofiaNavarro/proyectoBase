            ...
            <div class="col-12">
                <div class="card shadow-lg">
                    <div class="card-header bg-dark text-white">
                        <h4 class="mb-0"><i class="fas fa-pen colorpersonal"></i> Editar rol</h4>
                    </div>
                        ...
                        <form class="needs-validation" method="POST"  action="{{ url('/roles/'.$roles->id) }}" novalidate>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ $roles->name }}" maxlength="250" placeholder="Nombre del rol" required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ $roles->slug }}" maxlength="250" placeholder="Slug" readonly required>
                                    <div class="invalid-feedback">
