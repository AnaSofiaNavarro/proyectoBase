            ...
            <div class="col-12">
                <div class="card shadow-lg">
                    <div class="card-header bg-dark text-white">
                        <h4 class="mb-0"><i class="fas fa-pen colorpersonal"></i> Editar usuario</h4>
                    </div>

                    <div class="card-body">

                        <form class="needs-validation" method="POST" action="{{ url('/usuarios/' . $usuarios->id) }}"
                            novalidate>
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                        id="nombre" name="nombre" value="{{ $usuarios->name }}" maxlength="250"
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="tel" class="form-control" id="telefono" name="telefono"
                                        value="{{ $usuarios->tel }}" maxlength="20" placeholder="Número de teléfono" />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="email " class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ $usuarios->email }}" maxlength="250"
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="password" class="form-control" id="contraseña_confirmation"
                                        name="contraseña_confirmation" maxlength="250"
                                    ...
                                    <select id="secciones" name="secciones[]" multiple class="form-select"
                                        ...
                                        @foreach ($secciones as $seccion)
                                            <option value="{{ $seccion->idseccion }}"
                                                {{ in_array($seccion->idseccion, $seccionesSeleccionadas) ? 'selected' : '' }}>
                                            ...
                                            @foreach ($rolepermisos as $permisos)
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox"
                                                        name="permissions[]" id="{{ $permisos->slug }}"
                                                        value="{{ $permisos->id }}"
                                                        {{ in_array($permisos->id, $usuariopermisos->pluck('id')->toArray()) ? 'checked="checked"' : '' }}>
                                                    <label class="custom-control-label"
                                                        for="{{ $permisos->slug }}">{{ $permisos->name }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="form-control" name="nota" id="nota" cols="30" rows="3" placeholder="Nota">{{ $usuarios->nota }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-3">
                                    ...
                                    <input type="checkbox" class="form-control" id="activo" name="activo"
                                        ...
                                        @if ($usuarios->activo == 1) {{ 'checked' }} @endif />
                                </div>
                            </div>
