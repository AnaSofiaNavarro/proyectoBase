        ...
        <div class="col-12">
            <div class="card shadow-lg">
                <div class="card-header bg-dark text-white">
                    <h4 class="mb-0"><i class="fas fa-pen colorpersonal"></i> Editar sección</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" method="POST" action="{{url('/secciones/'.$secciones->idseccion)}}" novalidate>
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <select class="form-control @error('apartado') is-invalid @enderror chosen" name="apartado" id="apartado" required>
                                    ...
                                    @if ($secciones->fkapartado == $item->idapartado)
                        ...
                        <div class="form-row">
                            <div class="form-group col-4">
                                ...
                                <input class="form-control form-rounded @error('seccion') is-invalid @enderror" id="seccion" name="seccion" placeholder="Sección" value="{{$secciones->seccion}}" maxlength="250" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input class="form-control form-rounded" id="seccionen" name="seccionen" placeholder="Traducción sección" value="{{$secciones->seccionen}}" maxlength="250" />
                            </div>
                            <div class="form-group col-4">
                                <label for="slug">Slug: <span class="font-weight-bold text-danger">*</span></label>
                                <input class="form-control form-rounded @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="Slug" value="{{$secciones->slug}}" maxlength="250" readonly required />
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="form-group col-4">
                                ...
                                <input class="form-control form-rounded @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" placeholder="Descripción" value="{{$secciones->descripcion}}" maxlength="250" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input class="form-control form-rounded" id="descripcionen" name="descripcionen" placeholder="Traducción descripción" value="{{$secciones->descripcionen}}" maxlength="250" />
                            </div>
                            <div class="form-group col-4">
                                <label for="division">División:</label>
                                <input class="form-control form-rounded" id="division" name="division" placeholder="División" value="{{$secciones->division}}" maxlength="250" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-2">
                                ...
                                <input type="checkbox" class="form-control" id="enlace" name="enlace" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger" data-width="100%" @if($secciones->enlace == 1) {{'checked'}} @endif/>
                            </div>
                            <div class="form-group col-8">
                                <label for="url">Dirección electrónica:</label>
                                <input type="text" class="form-control" id="url" name="url" placeholder="Dirección electrónica" value="{{$secciones->url ?? ''}}" maxlength="250" @if(!$secciones->enlace == true) readonly @endif/>
                            </div>
                            <div class="form-group col-2">
                                <label for="target">Target:</label><br>
                                <input type="checkbox" class="form-control" id="target" name="target" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger" data-width="100%" @if($secciones->target == true) {{'checked'}} @endif @if(!$secciones->enlace == true) {{'disabled'}} @endif/>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="checkbox" class="form-control" id="activo" name="activo" data-toggle="toggle" data-on="Público" data-off="Privado" data-onstyle="success" data-offstyle="danger" data-width="100%" @if($secciones->activo == 1) {{'checked'}} @endif/>
                            </div>
                        </div>
