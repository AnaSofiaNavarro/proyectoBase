        ...
        <div class="col-12">
            <div class="card shadow-lg">
                <div class="card-header bg-dark text-white">
                    <h4 class="mb-0"><i class="fas fa-save colorpersonal"></i> Nuevo apartado</h4>
                </div>

                <div class="card-body">

                    <form class="needs-validation" method="POST" action="{{url('/apartados')}}" novalidate>
                        @csrf

                        <div class="form-row">
                            <div class="form-group col-4">
                                <label for="apartado">Apartado: <span class="font-weight-bold text-danger">*</span></label>
                                <input class="form-control @error('apartado') is-invalid @enderror" id="apartado" name="apartado" placeholder="Apartado" value="{{old('apartado')}}" maxlength="50" required />
                            ...
                            <div class="form-group col-4">
                                ...
                                <input class="form-control" id="apartadoen" name="apartadoen" placeholder="Traducción apartado" value="{{old('apartadoen')}}" maxlength="50" />
                            </div>
                            <div class="form-group col-4">
                                <label for="slug">Slug: <span class="font-weight-bold text-danger">*</span></label>
                                <input class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="Sluj" value="{{old('slug')}}" maxlength="50" readonly required />
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="form-group col-2">
                                ...
                                <input type="checkbox" class="form-control" id="menu" name="menu" data-toggle="toggle" data-on="Si" data-off="No" data-onstyle="success" data-offstyle="danger" data-width="100%" />
                            </div>
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="checkbox" class="form-control" id="activo" name="activo" data-toggle="toggle" data-on="Activo" data-off="Inactivo" data-onstyle="success" data-offstyle="danger" data-width="100%" checked />
                            </div>
                        </div>
