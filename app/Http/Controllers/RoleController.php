...
class RoleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $numero = Role::busqueda($vbusqueda)->orderBy('name', 'asc')->count();
        
        return view('roles.lista',compact('page', 'vbusqueda', 'roles', 'numero'));  
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'nombre' => 'required',
            'slug' => 'required|unique:roles,slug,'.$id.',id|max:255'
        ]);
